...
void ChimesJITev::poly_2B(double x0, int pairidx, double *e, double *f0)
{
  switch(pairidx) {
   ...
   break ;
   case 1:
   ChimesJITev::TiTi(x0, e, f0) ;
   break ;
   case 2:
   ChimesJITev::OTi(x0, e, f0) ;
   break ;
                        ...
                        double *f0, double *f1, double *f2)
{
  switch(tripidx) {
   ...
   break ;
   case 1:
   ChimesJITev::OOTi(x0, x1, x2, e, f0, f1, f2) ;
   break ;
   case 2:
   ChimesJITev::OTiTi(x0, x1, x2, e, f0, f1, f2) ;
   break ;
   case 3:
   ChimesJITev::TiTiTi(x0, x1, x2, e, f0, f1, f2) ;
   break ;
