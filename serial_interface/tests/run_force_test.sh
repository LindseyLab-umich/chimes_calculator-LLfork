...
##FFS[0 ]="validated_params.TiO2.2+3b.Tersoff.txt"                              ; CFGS[0 ]="TiO2.unitcell_arbrot_force_#000.xyz"                ; OPTIONS[0 ]="0"
FFS[0 ]="published_params.liqCO.2+3b.cubic.txt"                               ; CFGS[0 ]="CO.2.5gcc_6500K.OUTCAR_force_#000.xyz"              ; OPTIONS[0 ]="1"
	...
	do	
		...
		do
			...
			do
				...
				echo "Looking for configurations/$CFG"
